...
{
    public partial class fr_urun_karti : Form
    {
        ...
        public fr_urun_karti(string tablo_adi)
        {
            InitializeComponent();
        ...
        private void bt_ozellikler_Click(object sender, EventArgs e)
        {
            string filtre_ID = data_Grid.SelectedRows[0].Cells["ID"].Value.ToString();
            string urun_adi = data_Grid.SelectedRows[0].Cells["Adi"].Value.ToString();

            if (Application.OpenForms["fr_" + filtre_ID] == null)
            {
                fr_ozellikler f = new fr_ozellikler("ozellikler", filtre_ID, urun_adi);
                f.MdiParent = Application.OpenForms["fr_ana"];
